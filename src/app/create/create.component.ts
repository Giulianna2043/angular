        ...
        this._articleService.getArticle(params['id'])
          .subscribe(res => {
            ...
            this.articleFrm = this.fb.group({
              'name' : [this.article['name'], Validators.compose([Validators.required, Validators.minLength(5), Validators.maxLength(5)])],
              'telefono' : [this.article['telefono'], Validators.compose([Validators.required, Validators.minLength(10)])],
            });
          });
      } else {
        this.articleFrm = this.fb.group({
          'name' : [null, Validators.compose([Validators.required, Validators.minLength(9), Validators.maxLength(9)])],
